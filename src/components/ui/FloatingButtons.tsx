 ...
 * On mobile they appear full-width; on desktop they're compact circles with tooltip labels.
 */
      ...
      <div className="group relative flex items-center gap-2">
        ...
        <span
          className="
            ...
            bg-[#25D366] text-white text-xs font-semibold whitespace-nowrap
      ...
      <div className="group relative flex items-center gap-2">
        <span
          className="
            ...
            absolute right-[calc(100%+10px)] top-1/2 -translate-y-1/2
            items-center px-3 py-1.5 rounded-lg
            bg-[var(--color-primary-500)] text-white text-xs font-semibold whitespace-nowrap
            opacity-0 group-hover:opacity-100 group-focus-within:opacity-100
            transition-opacity duration-150 pointer-events-none
            shadow-[var(--shadow-card)]
          "
